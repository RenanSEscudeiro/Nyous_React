...
const CrudCategorias = () => {
    ...
    const [ categorias, setCategorias ] = useStates([]);
    ...
    let method = (id === 0 ? `${url}/categorias` :  `${url}/categorias/${id}`);
...
const editar = (event) => {
    ...
    .then(dado => {
        ...
        setUrlImagem(dado.data.url.Imagem);
    })
}
